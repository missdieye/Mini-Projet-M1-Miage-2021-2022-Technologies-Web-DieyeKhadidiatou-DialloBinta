  ...
  <div>
    <md-toolbar class="md-large diadie" v-if="this.path == '/commander'">
      ...
      <div>
        ...
        <p>
          Si vous passez votre commande à partir d'ici,elle sera traitée par le
          restaurant DIADIE.
        </p>
      </div>
    ...
    <div class="viewport">
                  ...
                  <md-card class="md-primary md-card" md-theme="green-card">
                    <md-card-header>
                      <md-card-media>
                        <img
                          :src="
                            require('../assets/horsOeuvres/' +
                              hordOeuvres[hordOeuvreCDP].src)
                          "
                          alt="Avatar"
                        />
                      </md-card-media>
                        ...
                        <md-card-actions md-alignment="space-between">
                          ...
                          <div>
                            <md-button class="md-raised prix" disabled
                              >Prix :
                              {{ hordOeuvres[hordOeuvreCDP].prix }} €</md-button
                            >
                          </div>
                          <div>
                            <md-button
                              class="md-raised btCom"
                              @click="
                                addCommande(
                                  hordOeuvres[hordOeuvreCDP].nom,
                                  hordOeuvres[hordOeuvreCDP].prix,
                                  qtit,
                                  'carte'
                                )
                              "
                      ...
                      <md-card-expand>
                        <md-card-actions md-alignment="space-between">
                          ...
                          <div>
                            <md-button class="md-raised prix" disabled
                              >Prix :
                              {{ desserts[dessertCDP].prix }} €</md-button
                            >
                          </div>
                          <div>
                            <md-button
                  ...
                  <md-card class="md-primary md-card" md-theme="green-card">
                    <md-card-header>
                      <md-card-media>
                        <img
                          :src="
                            require('../assets/plats/' + plats[platCDP].src)
                          "
                          alt="Avatar"
                        />
                      </md-card-media>
                      ...
                      <md-card-expand>
                        <md-card-actions md-alignment="space-between">
                          ...
                          <div>
                            <md-button class="md-raised prix" disabled
                              >Prix :
                              {{ boissons[boissonCDP].prix }} €</md-button
                            >
                          </div>
                          <div>
                            <md-button
      ...
      <div class="midi" v-if="type == 'midi'">
        <md-toolbar :md-elevation="1">
          <span class="md-title"
            >Menu Midi à <b>{{ this.prixMenuMidi }} €</b>
          </span>
        </md-toolbar>
        <md-toolbar :md-elevation="0">
          <b>
            <i>
              Choisissez un Hors d'Oeuvre, un plat, un dessert et un boisson de
              votre choix.</i
            ></b
          >
        </md-toolbar>
                        ...
                        <md-card-header>
                          <md-card-media>
                            <img
                              :src="
                                require('../assets/horsOeuvres/' +
                                  hordOeuvres[hordOeuvreMidi].src)
                              "
                              alt="Avatar"
                            />
                          </md-card-media>
                              ...
                              <div>
                                <md-button
                                  ...
                                  @click="
                                    getCommandeMidi(
                                      desserts[dessertMidi].nom,
                                      'desserts/' + desserts[dessertMidi].src
                                    ),
                                      setDone('third', 'fourth')
                                  "
                                  >Commander</md-button
                                >
                              </div>
                              ...
                              <div>
                                <md-button
                                  ...
                                  @click="
                                    getCommandeMidi(
                                      boissons[boissonMidi].nom,
                                      'boissons/' + boissons[boissonMidi].src
                                    ),
                                      setDone('fourth', 'first'),
                                      (activeRecap = true)
                                  "
                                  >Commander</md-button
                                >
        ...
        <md-dialog :md-active.sync="activeRecap">
          <md-dialog-title
            ...
            du Menu de Midi</md-dialog-title
          >
          <md-list class="md-triple-line md-dense">
            <md-list-item
              v-for="commandeMidi in this.commandesMidi"
              :key="commandeMidi"
            >
              <md-avatar>
                <img
                  :src="require('../assets/' + commandeMidi.src)"
                  alt="Image Commande"
                />
              </md-avatar>
          ...
          <md-dialog-actions>
            ...
            <md-button
              class="md-primary"
              @click="confirmer(commandesMidi), (activeRecap = false)"
              >Confirmer</md-button
            >
          </md-dialog-actions>
        </md-dialog>
      ...
      <div class="gastro" v-if="type == 'gastro'">
        <md-toolbar :md-elevation="1">
          <span class="md-title"
            >Menu Gastronomique à <b>{{ this.prixMenuGastro }} €</b></span
          >
        </md-toolbar>
        <md-toolbar :md-elevation="0">
          <b>
        ...
        <div class="list">
          <md-list>
            <md-steppers
              :md-active-step.sync="activeGastro"
              md-vertical
              md-linear
            >
              <md-step
                              ...
                              <div>
                                <md-button
                                  ...
                                  @click="
                                    getCommandeGastro(
                                      platsGastro[platGastro].nom,
                                      'plats/' + platsGastro[platGastro].src
                                    ),
                                      setDoneGastro(
                                        'secondGastro',
                                        'thirdGastro'
        ...
        <md-dialog :md-active.sync="activeRecapGastro">
          <md-dialog-title
            >Récapitulatif de votre Commande <br />
            du Menu Gastronomique</md-dialog-title
          >
          <md-list class="md-triple-line md-dense">
            <md-list-item
              v-for="commandeGastro in this.commandesGastro"
              :key="commandeGastro"
            >
              <md-avatar>
                <img
                  :src="require('../assets/gastro/' + commandeGastro.src)"
                  alt="Image Commande"
                />
              </md-avatar>
          ...
          <md-dialog-actions>
            <md-button class="md-primary" @click="annulerGastro()"
              >Annuler</md-button
            >
            <md-button
              class="md-primary"
              @click="confirmer(commandesGastro), (activeRecapGastro = false)"
              >Confirmer</md-button
            >
          </md-dialog-actions>
        </md-dialog>
    ...
    <div class="viewport commande">
      ...
      <md-table class="tabCom">
        ...
        <md-table-row v-for="commande in this.commandes" :key="commande">
          ...
          <md-table-cell v-if="commande.type == 'carte'" md-numeric>{{
            commande.quantite
          }}</md-table-cell>
          <md-table-cell v-if="commande.type == 'carte'" md-numeric>{{
            commande.prix
          ...
          <md-table-cell v-if="commande.type == 'menumidi'" md-numeric
            >Menu de midi</md-table-cell
          >
          <md-table-cell v-if="commande.type == 'menuGastro'" md-numeric
            >Menu Gastro</md-table-cell
          >
        </md-table-row>
      </md-table>
      <md-toolbar :md-elevation="1">
        <md-button class="md-raised prix" disabled
          >Prix Total : {{ this.getPrixCommande(commandes) }} €</md-button
        >
      </md-toolbar>
    </div>
  </div>
...
export default {
  ...
  mounted() {
    //Récupération des plats simples et gastronomiques
    ...
    this.prixDG = Menu.methods.getMenuGastronomique(0,this.dessertsGastro.length,this.dessertsGastrono,this.dessertsGastro
      ) / 2;
  ...
  methods: {
      //Ajouter une commande venant de la carte
    ...
    //Récupération commande passée sur le menu de Midi
    getCommandeMidi(des, img) {
      this.commandesMidi.push({ designation: des, src: img, type: "menumidi" });
    },

    //Récupération de la commande passée sur le menu gastronomique
    getCommandeGastro(des, img) {
      this.commandesGastro.push({
        designation: des,
        src: img,
        type: "menuGastro",
      });
    ...
    //Caclul du prix avec un pourcentage
    getPrixMidi(x) {
      x = x - x * 0.2;
      return x;
    },

    //Commande menu midi passée
    setDone(id, index) {
      this[id] = true;
    ...
    //Commande menu gastronomique passée
